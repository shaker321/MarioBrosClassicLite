...
class Game {
  ...
  gameOver() {
    return ((this.mario.marioX === this.turtles.turtle1X + 5 && this.mario.marioY + 10 === this.turtles.turtle1Y) ||
            (this.mario.marioX === this.turtles.turtle2X + 5 && this.mario.marioY + 10 === this.turtles.turtle2Y) ||
            (this.mario.marioX === this.turtles.turtle3X - 5 && this.mario.marioY + 10 === this.turtles.turtle3Y));
  }
  ...
  plusOrMinus(baseNumber, spreadNumber, questionedNumber) {
  ...
  killTurtle() {
    if (this.mario.marioY === this.turtles.turtle1Y + 37 && this.plusOrMinus(this.mario.marioX, 10, this.turtles.turtle1X).includes(this.turtles.turtle1X)) {
      this.shouldDrawTurtle1 = false;
    }

    if (this.mario.marioY === this.turtles.turtle2Y + 37 && this.plusOrMinus(this.mario.marioX, 10, this.turtles.turtle2X).includes(this.turtles.turtle2X)) {
      this.shouldDrawTurtle2 = false;
    }

    if (this.mario.marioY === this.turtles.turtle3Y + 37 && this.plusOrMinus(this.mario.marioX, 10, this.turtles.turtle3X).includes(this.turtles.turtle3X)) {
      this.shouldDrawTurtle3 = false;
    }
  }

  // listeners() {
  //   document.addEventListener("keydown", this.mario.keyDownHandler, false);
  //   document.addEventListener("keyup", this.mario.keyUpHandler, false);
  // }
